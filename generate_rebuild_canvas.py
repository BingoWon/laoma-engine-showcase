...
<body class="bg-blueprint-grid text-slate-800 font-sans antialiased overflow-hidden select-none w-screen h-screen">
    ...
    <div class="flex items-center gap-3">
      ...
      <div>
        <div class="flex items-center gap-2">
          ...
          <span class="text-[9px] font-mono font-bold px-1.5 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200">FIGMA-DRAGGABLE · 100% UNPROCESSED</span>
        </div>
        <div class="flex items-center gap-2 text-[10px] font-mono text-slate-400">
          ...
          <span>•</span>
          <span class="text-indigo-600 font-bold">按住卡片自由拖拽</span>
        </div>
      </div>
    </div>
  ...
  <main id="canvas-viewport" class="w-full h-full pt-14 relative overflow-hidden cursor-grab active:cursor-grabbing">
    <!-- Compact Stage: 4400px x 3100px (High-Density Engineering Layout) -->
    <div id="canvas-stage" class="absolute pointer-events-auto" style="width: 4400px; height: 3100px;">
      ...
      <!-- ===================================================================== -->
      <!-- ZONE NORTH (北部总成 · X: 1350, Y: 80) · 混合容器渲染内核与通信协议总成 -->
      <!-- ===================================================================== -->
      <div id="zone-north" class="absolute z-20 draggable-node blueprint-card p-6 rounded-2xl" style="left: 1350px; top: 80px; width: 1400px;">
      ...
      <!-- ===================================================================== -->
      <div id="zone-reference" class="absolute z-20 draggable-node blueprint-card p-5 rounded-2xl" style="left: 80px; top: 80px; width: 1180px;">
        ...
        <div class="mb-3.5">
          ...
          <div class="grid grid-cols-4 gap-2.5">
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-amber-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_real_1.jpg', '物理样张 01 · 蓝眼折射与正坐骨骼 (1600×900)')">
              <div class="w-full aspect-cine-16-9 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center">
                <img src="./assets/real_photos/laoma_real_1.jpg" class="no-crop-img" alt="样张1">
              </div>
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REF_REAL_01</div>
              <div class="text-[8px] text-slate-400 font-mono">1600×900 (16:9)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-amber-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_real_2.jpg', '物理样张 02 · 伏卧工况与耳廓解剖 (1600×900)')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REF_REAL_02</div>
              <div class="text-[8px] text-slate-400 font-mono">1600×900 (16:9)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-amber-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_photo_1.jpg', '物理样张 03 · 箱体内空间透视参考 (1920×1080)')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REF_PHOTO_01</div>
              <div class="text-[8px] text-slate-400 font-mono">1920×1080 (16:9)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-amber-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_photo_2.jpg', '物理样张 04 · 阳光漫反射光影采样 (1920×1080)')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REF_PHOTO_02</div>
              <div class="text-[8px] text-slate-400 font-mono">1920×1080 (16:9)</div>
            </div>
          </div>
        </div>
        ...
        <div class="mb-3.5">
          ...
          <div class="grid grid-cols-5 gap-2.5">
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_real_3.jpg', '骨骼样张 01 · 站立侧身脊椎弧度')">
              <div class="w-full aspect-photo-3-4 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center">
                <img src="./assets/real_photos/laoma_real_3.jpg" class="no-crop-img" alt="骨骼1">
              </div>
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REAL_03</div>
              <div class="text-[8px] text-slate-400 font-mono">3:4 (0.75)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_real_4.jpg', '骨骼样张 02 · 伏地探头警戒形态')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REAL_04</div>
              <div class="text-[8px] text-slate-400 font-mono">3:4 (0.75)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_real_5.jpg', '骨骼样张 03 · 蜷缩入睡放松肌肉群')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REAL_05</div>
              <div class="text-[8px] text-slate-400 font-mono">3:4 (0.75)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_real_6.jpg', '骨骼样张 04 · 后腿蹬踏动力学')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REAL_06</div>
              <div class="text-[8px] text-slate-400 font-mono">3:4 (0.75)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_real_7.jpg', '骨骼样张 05 · 直立抬头空间视点')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">REAL_07</div>
              <div class="text-[8px] text-slate-400 font-mono">3:4 (0.75)</div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="grid grid-cols-3 gap-2.5">
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-emerald-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_photo_3.jpg', '微距光学 01 · 毛发高频法线与次表面散射 (5712×4284)')">
              <div class="w-full aspect-photo-4-3 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center">
                <img src="./assets/real_photos/laoma_photo_3.jpg" class="no-crop-img" alt="微距1">
              </div>
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">PHOTO_03</div>
              <div class="text-[8px] text-slate-400 font-mono">5712×4284 (4:3)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-emerald-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_photo_4.jpg', '微距光学 02 · 虹膜收缩与瞳孔高动态范围 (5712×4284)')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">PHOTO_04</div>
              <div class="text-[8px] text-slate-400 font-mono">5712×4284 (4:3)</div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-emerald-400 transition-all" onclick="inspectImage('./assets/real_photos/laoma_photo_5.jpg', '微距光学 03 · 鼻吻部触觉感知物理建模 (5712×4284)')">
              ...
              <div class="text-[9px] font-bold text-slate-700 font-mono truncate">PHOTO_05</div>
              <div class="text-[8px] text-slate-400 font-mono">5712×4284 (4:3)</div>
            </div>
          </div>
        </div>
      ...
      <!-- ===================================================================== -->
      <!-- ZONE NORTHEAST (东北总成 · X: 2850, Y: 80) · 视觉识别与多工况候选机身阵列 -->
      <!-- ===================================================================== -->
      <div id="zone-candidates" class="absolute z-20 draggable-node blueprint-card p-5 rounded-2xl" style="left: 2850px; top: 80px; width: 1460px;">
        <div class="flex items-center justify-between border-b border-slate-200 pb-3 mb-3.5 node-drag-handle">
          <div class="flex items-center gap-2.5">
        ...
        <div class="mb-3.5">
          <div class="flex items-center justify-between mb-1.5">
            <span class="text-[10px] font-black text-slate-700 font-mono flex items-center gap-1">
              ...
              <span>GROUP A · 19.5:9 视觉脏污判定与交互模型候选样张 (851×1848 / 941×1672)</span>
            </span>
          ...
          <div class="grid grid-cols-6 gap-2.5">
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/candidates/dirty_cat_candidate_1.png', 'CV候选01 · 办公工位脏污轻度')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">CANDIDATE_01</div>
              <div class="text-[7.5px] text-slate-400 font-mono">851×1848 (0.46)</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/candidates/dirty_cat_candidate_2.png', 'CV候选02 · 地面泥泞脏污中度')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">CANDIDATE_02</div>
              <div class="text-[7.5px] text-slate-400 font-mono">851×1848 (0.46)</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/candidates/dirty_cat_candidate_3.png', 'CV候选03 · 户外探险脏污重度')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">CANDIDATE_03</div>
              <div class="text-[7.5px] text-slate-400 font-mono">851×1848 (0.46)</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/candidates/dirty_cat_sample_1.png', '姿态样张01 · 侧卧脏污识别')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">SAMPLE_01</div>
              <div class="text-[7.5px] text-slate-400 font-mono">941×1672 (0.56)</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/candidates/dirty_cat_sample_2.png', '姿态样张02 · 伏击脏污识别')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">SAMPLE_02</div>
              <div class="text-[7.5px] text-slate-400 font-mono">941×1672 (0.56)</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/candidates/dirty_cat_sample_3.png', '姿态样张03 · 站立脏污识别')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">SAMPLE_03</div>
              <div class="text-[7.5px] text-slate-400 font-mono">941×1672 (0.56)</div>
            </div>
          </div>
        </div>
        ...
        <div class="mb-3.5">
          <div class="flex items-center justify-between mb-1.5">
            <span class="text-[10px] font-black text-slate-700 font-mono flex items-center gap-1">
              ...
              <span>GROUP B · 19.5:9 端侧原生全分辨率多工况渲染帧 (1320×2868 原生视口 · 零剪裁)</span>
            </span>
          ...
          <div class="grid grid-cols-6 gap-2.5">
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/app_assets/app_bg.png', '基线背景 · 1320×2868 纯净居室底图')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">APP_BG_RAW</div>
              <div class="text-[7.5px] text-slate-400 font-mono">1320×2868</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/candidates/home_bg_clean_1320x2868.png', '基线渲染 · 1320×2868 纯净居室标准光照')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">BG_CLEAN_HD</div>
              <div class="text-[7.5px] text-slate-400 font-mono">1320×2868</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/candidates/home_cat_bg_clean_1320x2868.png', '工况合成 · 1320×2868 纯净常态猫咪完整视口')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">CAT_CLEAN_HD</div>
              <div class="text-[7.5px] text-slate-400 font-mono">1320×2868</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/candidates/home_cat_dirty_tap_1320x2868.png', '工况合成 · 1320×2868 脏污高灵敏触碰视口')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">DIRTY_TAP_HD</div>
              <div class="text-[7.5px] text-slate-400 font-mono">1320×2868</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/candidates/home_cat_touch_screen_1320x2868.png', '工况合成 · 1320×2868 屏幕互动触碰贴合视口')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">TOUCH_SCR_HD</div>
              <div class="text-[7.5px] text-slate-400 font-mono">1320×2868</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/candidates/home_bg_clean_exact_ratio.png', '校准基线 · 848×1844 精密等比视口标定图')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">EXACT_RATIO</div>
              <div class="text-[7.5px] text-slate-400 font-mono">848×1844</div>
            </div>
          </div>
        </div>

        <!-- Section C: Office Ambient Dirty Cat Candidates -->
        <div>
          <div class="flex items-center justify-between mb-1.5">
            <span class="text-[10px] font-black text-slate-700 font-mono flex items-center gap-1">
              <span class="w-1.5 h-1.5 rounded-full bg-amber-500"></span>
          ...
          <div class="grid grid-cols-5 gap-2.5">
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-amber-400 transition-all" onclick="inspectImage('./assets/candidates/office_dirty_cat_candidate_1.png', '办公光照候选 01 (851×1848)')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">OFFICE_01</div>
              <div class="text-[7.5px] text-slate-400 font-mono">851×1848</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-amber-400 transition-all" onclick="inspectImage('./assets/candidates/office_dirty_cat_candidate_2.png', '办公光照候选 02 (851×1848)')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">OFFICE_02</div>
              <div class="text-[7.5px] text-slate-400 font-mono">851×1848</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-amber-400 transition-all" onclick="inspectImage('./assets/candidates/office_dirty_cat_candidate_3.png', '办公光照候选 03 (851×1848)')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">OFFICE_03</div>
              <div class="text-[7.5px] text-slate-400 font-mono">851×1848</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-indigo-400 transition-all" onclick="inspectImage('./assets/app_assets/scenes/leaderboard_magic_glass.png', '场景探索 01 · 魔法毛玻璃排行榜')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">MAGIC_GLASS</div>
              <div class="text-[7.5px] text-slate-400 font-mono">851×1848</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-indigo-400 transition-all" onclick="inspectImage('./assets/app_assets/scenes/leaderboard_cozy_journal.png', '场景探索 02 · 暖调手账持久化记录')">
              ...
              <div class="text-[8.5px] font-bold text-slate-700 font-mono truncate">COZY_JOURNAL</div>
              <div class="text-[7.5px] text-slate-400 font-mono">851×1849</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- ===================================================================== -->
      <!-- CENTER CORE ASSEMBLY (中心总装 · X: 1850, Y: 1050) · 真实应用界面与四大子系统展开 -->
      <!-- ===================================================================== -->
      <!-- 1. Central Honor Magic Device Frame (搭载真实应用界面截图) -->
      <div id="core-device-frame" class="absolute z-30 draggable-node" style="left: 1850px; top: 1050px; width: 380px; height: 820px;">
        ...
        <div class="w-full h-full bg-slate-900 rounded-[48px] p-2.5 shadow-2xl border-4 border-slate-700/90 ring-1 ring-white/20 relative flex flex-col justify-between">
          ...
          <div class="w-full h-full bg-white rounded-[38px] overflow-hidden relative border border-slate-800 flex flex-col justify-between select-none">
            ...
            <div class="absolute bottom-2.5 right-2.5 z-20 bg-black/50 backdrop-blur-md px-2 py-0.5 rounded-full text-[9px] text-white font-mono font-bold flex items-center gap-1 pointer-events-none">
              <span class="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping"></span>
              <span id="current-screen-tag">STATE: 01 常态静止巡航</span>
            </div>
          </div>
        </div>
      ...
      <div id="module-gauges" class="absolute z-20 draggable-node exploded-sub-module blueprint-card p-4 rounded-2xl cursor-pointer hover:border-blue-500" style="left: 1790px; top: 680px; width: 500px;" onclick="inspectComponent('gauges')">
        ...
        <div class="grid grid-cols-3 gap-2 text-center">
          <div class="p-2 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <div class="text-[7.5px] text-slate-400 font-mono">爱猫指数加权</div>
          </div>
          <div class="p-2 rounded-xl bg-slate-50 border border-slate-200">
            <div class="w-8 h-8 mx-auto mb-1 flex items-center justify-center">
            ...
            <div class="text-[7.5px] text-slate-400 font-mono">生理状态监测</div>
          </div>
          <div class="p-2 rounded-xl bg-slate-50 border border-slate-200">
            <div class="w-8 h-8 mx-auto mb-1 flex items-center justify-center">
            ...
            <div class="text-[7.5px] text-slate-400 font-mono">荣誉段位同步</div>
          </div>
        </div>
      </div>

      <!-- 3. Exploded Sub-Assembly 02: Media Stream & GPU Render Pipeline (ASM-02 · MEDIA) -->
      <!-- 视频正常在专属多媒体观测站中静音循环播放 -->
      <div id="module-media" class="absolute z-20 draggable-node exploded-sub-module blueprint-card p-4 rounded-2xl cursor-pointer hover:border-emerald-500" style="left: 2350px; top: 1100px; width: 480px;" onclick="inspectComponent('media')">
        <div class="flex items-center justify-between border-b border-slate-200 pb-2 mb-2.5 node-drag-handle">
          <div class="flex items-center gap-2">
            <span class="w-6 h-6 rounded-lg bg-emerald-50 border border-emerald-200 flex items-center justify-center text-xs">🎬</span>
            <div>
              <h4 class="text-xs font-black text-slate-900">视觉多媒体硬件解码与动效管线 (正常播放中)</h4>
              <span class="text-[8.5px] font-mono text-emerald-600 font-bold">[ASM-02 · MEDIA PIPELINE & GPU ACCELERATION]</span>
            </div>
          </div>
          <span class="text-[8.5px] font-mono px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 font-bold">DISSECTED</span>
        </div>

        <!-- 3 Hardware Media Stream Cards with AUTOPLAYING VIDEOS -->
        <div class="grid grid-cols-3 gap-2 mb-2">
          <div class="bg-slate-900 rounded-lg p-1 relative overflow-hidden aspect-video flex items-center justify-center shadow-inner">
            <video src="./assets/app_assets/home_cat_clean.mp4" autoplay loop muted playsinline class="w-full h-full object-contain"></video>
            <span class="absolute top-1 left-1 px-1 py-0.2 rounded bg-emerald-500/80 text-[7px] text-white font-mono font-bold">STREAM 01</span>
          </div>
          <div class="bg-slate-900 rounded-lg p-1 relative overflow-hidden aspect-video flex items-center justify-center shadow-inner">
            <video src="./assets/app_assets/home_cat_dirty.mp4" autoplay loop muted playsinline class="w-full h-full object-contain"></video>
            <span class="absolute top-1 left-1 px-1 py-0.2 rounded bg-amber-500/80 text-[7px] text-white font-mono font-bold">STREAM 02</span>
          </div>
          <div class="bg-slate-900 rounded-lg p-1 relative overflow-hidden aspect-video flex items-center justify-center shadow-inner">
            <video src="./assets/app_assets/home_cat_touch.mp4" autoplay loop muted playsinline class="w-full h-full object-contain"></video>
            <span class="absolute top-1 left-1 px-1 py-0.2 rounded bg-rose-500/80 text-[7px] text-white font-mono font-bold">STREAM 03</span>
          </div>
        </div>
        <div class="flex items-center justify-between text-[8.5px] font-mono text-slate-500 bg-slate-100/80 p-1.5 rounded-lg">
          ...
          <span>HARDWARE ACCEL: ACTIVE</span>
          <span>60 FPS LOCKED</span>
        </div>
      </div>

      <!-- 4. Exploded Sub-Assembly 03: 24H Spatial Timeline & 11 Care Props (ASM-03 · TIMELINE) -->
      <div id="module-timeline" class="absolute z-20 draggable-node exploded-sub-module blueprint-card p-4 rounded-2xl cursor-pointer hover:border-amber-500" style="left: 1250px; top: 1100px; width: 480px;" onclick="inspectComponent('timeline')">
        <div class="flex items-center justify-between border-b border-slate-200 pb-2 mb-2.5 node-drag-handle">
          <div class="flex items-center gap-2">
            ...
            <div>
              ...
              <span class="text-[8.5px] font-mono text-amber-600 font-bold">[ASM-03 · 24H SPATIAL TIMELINE BUS & 11 PROPS]</span>
            </div>
          </div>
          <span class="text-[8.5px] font-mono px-2 py-0.5 rounded-full bg-amber-50 text-amber-700 font-bold">DISSECTED</span>
        </div>

        <div id="dissected-timeline-grid" class="grid grid-cols-4 gap-2 mb-2">
        ...
        <div class="text-[8.5px] font-mono text-slate-500 bg-slate-100/80 p-1.5 rounded-lg flex items-center justify-between">
          ...
          <span>BLE LOW-POWER SENSORS</span>
        </div>
      </div>

      <!-- 5. Exploded Sub-Assembly 04: Dual Trapezoid Bento Physics & Leaderboard (ASM-04 · BENTO) -->
      <div id="module-bento" class="absolute z-20 draggable-node exploded-sub-module blueprint-card p-4 rounded-2xl cursor-pointer hover:border-indigo-500" style="left: 1790px; top: 1950px; width: 500px;" onclick="inspectComponent('bento')">
        <div class="flex items-center justify-between border-b border-slate-200 pb-2 mb-2.5 node-drag-handle">
          <div class="flex items-center gap-2">
        ...
        <div class="relative h-18 bg-slate-900/5 rounded-xl p-2 flex items-center justify-around border border-slate-200 mb-2">
          <div class="flex items-center gap-2">
            ...
            <div class="text-left">
              <div class="text-[9.5px] font-black text-slate-800 font-mono">实时爱猫榜</div>
              <div class="text-[7.5px] text-slate-400 font-mono">10.3° 倾角切边</div>
            </div>
          </div>
          <div class="h-6 w-px bg-slate-300"></div>
          <!-- Tiny 3D Podium at REALISTIC small scale -->
          <div class="flex items-center gap-1.5">
            <div class="w-14 h-7 flex items-center justify-center">
              <img src="./assets/app_assets/generated/podium_3d.png" class="no-crop-img drop-shadow-2xs" alt="领奖台">
            </div>
            <div class="text-left">
              <div class="text-[9.5px] font-black text-slate-800 font-mono">微型奖励台</div>
              <div class="text-[7.5px] text-slate-400 font-mono">真实 UI 配件</div>
            </div>
          </div>
        </div>
        <div class="text-[8.5px] font-mono text-slate-500 bg-slate-100/80 p-1.5 rounded-lg flex items-center justify-between">
      ...
      <!-- ===================================================================== -->
      <div id="zone-bom" class="absolute z-20 draggable-node blueprint-card p-5 rounded-2xl" style="left: 80px; top: 980px; width: 1100px;">
        <div class="flex items-center justify-between border-b border-slate-200 pb-3 mb-3.5 node-drag-handle">
          <div class="flex items-center gap-2.5">
            <span class="w-8 h-8 rounded-xl bg-indigo-50 border border-indigo-200 flex items-center justify-center text-base">📦</span>
            <div>
              <h2 class="text-sm font-black text-slate-900 tracking-tight">工程物料清单与全量数字资产规格墙 (保留自然透视轮廓 · 零裁剪)</h2>
        ...
        <div class="mb-3.5">
          ...
          <div id="unified-bom-items" class="grid grid-cols-6 gap-2">
            <!-- Rendered via JS -->
          </div>
        </div>
        ...
        <div class="mb-3.5">
          ...
          <div id="unified-bom-icons" class="grid grid-cols-6 gap-2">
            <!-- Rendered via JS -->
          </div>
        </div>
        ...
        <div class="mb-3.5">
          ...
          <div class="grid grid-cols-9 gap-2">
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-emerald-400 transition-all text-center" onclick="inspectImage('./assets/app_assets/generated/status_food.png', '体征微章 · 饱食度正常指数 (1254×1254 · 1:1)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/app_assets/generated/status_food.png" class="no-crop-img" alt="饱食度">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">FOOD</div>
              <div class="text-[7px] text-slate-400 font-mono">1:1 正方</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-emerald-400 transition-all text-center" onclick="inspectImage('./assets/app_assets/generated/status_water.png', '体征微章 · 饮水含水量达标 (1254×1254 · 1:1)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/app_assets/generated/status_water.png" class="no-crop-img" alt="饮水">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">WATER</div>
              <div class="text-[7px] text-slate-400 font-mono">1:1 正方</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-emerald-400 transition-all text-center" onclick="inspectImage('./assets/app_assets/generated/status_litter.png', '体征微章 · 猫砂洁净排泄指标 (1254×1254 · 1:1)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/app_assets/generated/status_litter.png" class="no-crop-img" alt="猫砂">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">LITTER</div>
              <div class="text-[7px] text-slate-400 font-mono">1:1 正方</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-emerald-400 transition-all text-center" onclick="inspectImage('./assets/app_assets/generated/status_bath.png', '体征微章 · 毛发清洁洗护指数 (1254×1254 · 1:1)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/app_assets/generated/status_bath.png" class="no-crop-img" alt="洗护">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">BATH</div>
              <div class="text-[7px] text-slate-400 font-mono">1:1 正方</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-indigo-400 transition-all text-center" onclick="inspectImage('./assets/app_assets/hero_cat_sitting_tight.png', '立绘切图 · 老马紧凑正坐形态 (841×1112 · 0.756)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/app_assets/hero_cat_sitting_tight.png" class="no-crop-img" alt="正坐立绘">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">SITTING</div>
              <div class="text-[7px] text-slate-400 font-mono">841×1112</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-indigo-400 transition-all text-center" onclick="inspectImage('./assets/app_assets/hero_cat_carrier_tight.png', '立绘切图 · 老马外出猫包形态 (1018×1112 · 0.916)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/app_assets/hero_cat_carrier_tight.png" class="no-crop-img" alt="猫包立绘">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">CARRIER</div>
              <div class="text-[7px] text-slate-400 font-mono">1018×1112</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all text-center" onclick="inspectImage('./assets/candidates/app_icon_preview.png', '品牌应用图标 · 660×660 原生矢量渲染 (1:1)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/candidates/app_icon_preview.png" class="no-crop-img" alt="应用图标">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">APP_ICON</div>
              <div class="text-[7px] text-slate-400 font-mono">660×660</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all text-center" onclick="inspectImage('./assets/candidates/app_icon_preview_orig.png', '品牌应用图标原始母版 · 660×660 原生画幅 (1:1)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/candidates/app_icon_preview_orig.png" class="no-crop-img" alt="应用图标母版">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">ICON_ORIG</div>
              <div class="text-[7px] text-slate-400 font-mono">660×660</div>
            </div>
            <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all text-center" onclick="inspectImage('./assets/app_assets/ic_board_feishu_badge.png', '系统配件 · 飞书多维协作角标道具 (224×212)')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg mx-auto mb-1 flex items-center justify-center p-0.5 border border-slate-200">
                <img src="./assets/app_assets/ic_board_feishu_badge.png" class="no-crop-img" alt="飞书角标">
              </div>
              <div class="text-[8px] font-black text-slate-800 font-mono truncate">FEISHU_B</div>
              <div class="text-[7px] text-slate-400 font-mono">224×212</div>
            </div>
          </div>
        </div>
        ...
        <div class="mb-3.5">
          ...
          <div class="grid grid-cols-4 gap-2.5">
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all flex items-center gap-2" onclick="inspectImage('./assets/app_assets/ic_tile_yoyo.png', '系统磁贴 · 荣耀YOYO智能体接入')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg flex items-center justify-center p-0.5 border border-slate-200 shadow-2xs">
                <img src="./assets/app_assets/ic_tile_yoyo.png" class="no-crop-img" alt="YOYO">
              </div>
              <div>
                <div class="text-[9px] font-black text-slate-800 font-mono">TILE_YOYO</div>
                <div class="text-[8px] text-cyan-600 font-mono">YOYO专属</div>
              </div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all flex items-center gap-2" onclick="inspectImage('./assets/app_assets/ic_tile_feishu.png', '系统磁贴 · 飞书多维表格与办公协同')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg flex items-center justify-center p-0.5 border border-slate-200 shadow-2xs">
                <img src="./assets/app_assets/ic_tile_feishu.png" class="no-crop-img" alt="飞书">
              </div>
              <div>
                <div class="text-[9px] font-black text-slate-800 font-mono">TILE_FEISHU</div>
                <div class="text-[8px] text-cyan-600 font-mono">飞书同步</div>
              </div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all flex items-center gap-2" onclick="inspectImage('./assets/app_assets/ic_tile_health.png', '系统磁贴 · 荣耀健康生理数据通道')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg flex items-center justify-center p-0.5 border border-slate-200 shadow-2xs">
                <img src="./assets/app_assets/ic_tile_health.png" class="no-crop-img" alt="健康">
              </div>
              <div>
                <div class="text-[9px] font-black text-slate-800 font-mono">TILE_HEALTH</div>
                <div class="text-[8px] text-cyan-600 font-mono">健康总线</div>
              </div>
            </div>
            <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-cyan-400 transition-all flex items-center gap-2" onclick="inspectImage('./assets/app_assets/ic_tile_journal.png', '系统磁贴 · 喵务日常手账入口')">
              <div class="w-9 h-9 cleanroom-pad rounded-lg flex items-center justify-center p-0.5 border border-slate-200 shadow-2xs">
                <img src="./assets/app_assets/ic_tile_journal.png" class="no-crop-img" alt="手账">
              </div>
              <div>
                <div class="text-[9px] font-black text-slate-800 font-mono">TILE_JOURNAL</div>
                <div class="text-[8px] text-cyan-600 font-mono">手账入口</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div id="unified-bom-archives" class="grid grid-cols-7 gap-2">
            <!-- Rendered via JS -->
          </div>
        </div>
      </div>
      ...
      <!-- ===================================================================== -->
      <!-- ZONE EAST (东部总成 · X: 2950, Y: 980) · 8 大端侧真机全工况全分辨率验证流   -->
      <!-- ===================================================================== -->
      <div id="zone-screens" class="absolute z-20 draggable-node blueprint-card p-5 rounded-2xl" style="left: 2950px; top: 980px; width: 1360px;">
        <div class="flex items-center justify-between border-b border-slate-200 pb-3 mb-3.5 node-drag-handle">
          <div class="flex items-center gap-2.5">
            <span class="w-8 h-8 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-center text-base">📱</span>
            <div>
              <h2 class="text-sm font-black text-slate-900 tracking-tight">8 大端侧真机全工况全分辨率实测大屏 (1320 × 2868 · 零剪裁)</h2>
        ...
        <div class="grid grid-cols-4 gap-3.5">
          ...
          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/screenshots/Screenshot_20260919_174540_com_lyi_laomayoyo_MainActivity.JPG', '真机工况 01 · 居室常态静止巡航 (1320×2868)')">
            <div class="w-full aspect-phone bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center shadow-inner">
              <img src="./assets/screenshots/Screenshot_20260919_174540_com_lyi_laomayoyo_MainActivity.JPG" class="no-crop-img" alt="工况1">
            </div>
            <div class="text-[9px] font-black text-slate-800 font-mono truncate">01 · 居室常态巡航</div>
            <div class="text-[8px] text-slate-400 font-mono">1320×2868 · 17:45:40</div>
          </div>

          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/screenshots/Screenshot_20260919_174600_com_lyi_laomayoyo_MainActivity.JPG', '真机工况 02 · 屏幕触碰响应反馈 (1320×2868)')">
            <div class="w-full aspect-phone bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center shadow-inner">
              <img src="./assets/screenshots/Screenshot_20260919_174600_com_lyi_laomayoyo_MainActivity.JPG" class="no-crop-img" alt="工况2">
            </div>
            <div class="text-[9px] font-black text-slate-800 font-mono truncate">02 · 触控互动反馈</div>
            <div class="text-[8px] text-slate-400 font-mono">1320×2868 · 17:46:00</div>
          </div>

          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/screenshots/Screenshot_20260919_174613_com_lyi_laomayoyo_MainActivity.JPG', '真机工况 03 · 脏污状态视觉告警 (1320×2868)')">
            <div class="w-full aspect-phone bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center shadow-inner">
              <img src="./assets/screenshots/Screenshot_20260919_174613_com_lyi_laomayoyo_MainActivity.JPG" class="no-crop-img" alt="工况3">
            </div>
            <div class="text-[9px] font-black text-slate-800 font-mono truncate">03 · 脏污告警流转</div>
            <div class="text-[8px] text-slate-400 font-mono">1320×2868 · 17:46:13</div>
          </div>

          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/screenshots/Screenshot_20260919_174628_com_lyi_laomayoyo_MainActivity.JPG', '真机工况 04 · 抚摸清洁自愈过程 (1320×2868)')">
            <div class="w-full aspect-phone bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center shadow-inner">
              <img src="./assets/screenshots/Screenshot_20260919_174628_com_lyi_laomayoyo_MainActivity.JPG" class="no-crop-img" alt="工况4">
            </div>
            <div class="text-[9px] font-black text-slate-800 font-mono truncate">04 · 抚触自愈过程</div>
            <div class="text-[8px] text-slate-400 font-mono">1320×2868 · 17:46:28</div>
          </div>

          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/screenshots/Screenshot_20260919_174648_com_lyi_laomayoyo_MainActivity.JPG', '真机工况 05 · 定额食物投喂事件 (1320×2868)')">
            <div class="w-full aspect-phone bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center shadow-inner">
              <img src="./assets/screenshots/Screenshot_20260919_174648_com_lyi_laomayoyo_MainActivity.JPG" class="no-crop-img" alt="工况5">
            </div>
            <div class="text-[9px] font-black text-slate-800 font-mono truncate">05 · 定额食物投喂</div>
            <div class="text-[8px] text-slate-400 font-mono">1320×2868 · 17:46:48</div>
          </div>

          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/screenshots/Screenshot_20260919_174700_com_lyi_laomayoyo_MainActivity.JPG', '真机工况 06 · 逗猫棒动力学捕捉 (1320×2868)')">
            <div class="w-full aspect-phone bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center shadow-inner">
              <img src="./assets/screenshots/Screenshot_20260919_174700_com_lyi_laomayoyo_MainActivity.JPG" class="no-crop-img" alt="工况6">
            </div>
            <div class="text-[9px] font-black text-slate-800 font-mono truncate">06 · 逗猫棒动力学</div>
            <div class="text-[8px] text-slate-400 font-mono">1320×2868 · 17:47:00</div>
          </div>

          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/screenshots/Screenshot_20260919_174713_com_lyi_laomayoyo_MainActivity.JPG', '真机工况 07 · 听诊心率健康体检 (1320×2868)')">
            <div class="w-full aspect-phone bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center shadow-inner">
              <img src="./assets/screenshots/Screenshot_20260919_174713_com_lyi_laomayoyo_MainActivity.JPG" class="no-crop-img" alt="工况7">
            </div>
            <div class="text-[9px] font-black text-slate-800 font-mono truncate">07 · 生理体检听诊</div>
            <div class="text-[8px] text-slate-400 font-mono">1320×2868 · 17:47:13</div>
          </div>

          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 cursor-pointer hover:border-blue-400 transition-all" onclick="inspectImage('./assets/screenshots/Screenshot_20260919_174724_com_lyi_laomayoyo_MainActivity.JPG', '真机工况 08 · 静音恒温安睡模式 (1320×2868)')">
            <div class="w-full aspect-phone bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center shadow-inner">
              <img src="./assets/screenshots/Screenshot_20260919_174724_com_lyi_laomayoyo_MainActivity.JPG" class="no-crop-img" alt="工况8">
            </div>
            <div class="text-[9px] font-black text-slate-800 font-mono truncate">08 · 空间静音安睡</div>
            <div class="text-[8px] text-slate-400 font-mono">1320×2868 · 17:47:24</div>
          </div>
        </div>
      </div>

      <!-- ===================================================================== -->
      <!-- ZONE SOUTHWEST (西南总成 · X: 80, Y: 2200) · 16:9 时序视频工况 (正常自动播放) -->
      <!-- ===================================================================== -->
      <div id="zone-posters" class="absolute z-20 draggable-node blueprint-card p-5 rounded-2xl" style="left: 80px; top: 2200px; width: 1200px;">
        <div class="flex items-center justify-between border-b border-slate-200 pb-3 mb-3.5 node-drag-handle">
          <div class="flex items-center gap-2.5">
            <span class="w-8 h-8 rounded-xl bg-indigo-50 border border-indigo-200 flex items-center justify-center text-base">🎞️</span>
            <div>
              <h3 class="font-black text-slate-900 text-xs">16:9 时序视频动作捕捉观测站 (6 大硬件 MP4 视频流正常播放 · 零剪裁)</h3>
              <span class="text-[9px] font-mono text-indigo-700 font-bold">[VID-POSTERS · 16:9 TEMPORAL MOTION CAPTURE & AUTOPLAY VIDEO NODES]</span>
            </div>
          </div>
          <span class="text-[9px] px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-700 font-mono font-bold border border-indigo-200">6 VIDEO STREAMS</span>
        </div>

        <div class="grid grid-cols-6 gap-2.5">
          <!-- 6 Video Players Running Normally with Controls and Autoplay -->
          <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all">
            <div class="w-full aspect-cine-16-9 bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center relative">
              <video src="./assets/app_assets/archives/videos/vid_cat_controlled.mp4" poster="./assets/video_posters/vid_cat_controlled_poster.jpg" autoplay loop muted playsinline controls class="w-full h-full object-contain"></video>
            </div>
            <div class="text-[8.5px] font-bold text-slate-800 font-mono truncate">01 · 机械受控</div>
            <div class="text-[7.5px] text-slate-400 font-mono">1280×720 · 16:9 MP4</div>
          </div>

          <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all">
            <div class="w-full aspect-cine-16-9 bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center relative">
              <video src="./assets/app_assets/archives/videos/vid_cat_feast.mp4" poster="./assets/video_posters/vid_cat_feast_poster.jpg" autoplay loop muted playsinline controls class="w-full h-full object-contain"></video>
            </div>
            <div class="text-[8.5px] font-bold text-slate-800 font-mono truncate">02 · 享用盛宴</div>
            <div class="text-[7.5px] text-slate-400 font-mono">1280×720 · 16:9 MP4</div>
          </div>

          <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all">
            <div class="w-full aspect-cine-16-9 bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center relative">
              <video src="./assets/app_assets/archives/videos/vid_cat_taste_after.mp4" poster="./assets/video_posters/vid_cat_taste_after_poster.jpg" autoplay loop muted playsinline controls class="w-full h-full object-contain"></video>
            </div>
            <div class="text-[8.5px] font-bold text-slate-800 font-mono truncate">03 · 餐后清洁</div>
            <div class="text-[7.5px] text-slate-400 font-mono">1280×720 · 16:9 MP4</div>
          </div>

          <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all">
            <div class="w-full aspect-cine-16-9 bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center relative">
              <video src="./assets/app_assets/archives/videos/vid_cat_charming_belly.mp4" poster="./assets/video_posters/vid_cat_charming_belly_poster.jpg" autoplay loop muted playsinline controls class="w-full h-full object-contain"></video>
            </div>
            <div class="text-[8.5px] font-bold text-slate-800 font-mono truncate">04 · 露腹互动</div>
            <div class="text-[7.5px] text-slate-400 font-mono">1280×720 · 16:9 MP4</div>
          </div>

          <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all">
            <div class="w-full aspect-cine-16-9 bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center relative">
              <video src="./assets/app_assets/archives/videos/vid_cat_fire_extinguisher.mp4" poster="./assets/video_posters/vid_cat_fire_extinguisher_poster.jpg" autoplay loop muted playsinline controls class="w-full h-full object-contain"></video>
            </div>
            <div class="text-[8.5px] font-bold text-slate-800 font-mono truncate">05 · 避障探索</div>
            <div class="text-[7.5px] text-slate-400 font-mono">1280×720 · 16:9 MP4</div>
          </div>

          <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all">
            <div class="w-full aspect-cine-16-9 bg-slate-900 rounded-lg overflow-hidden mb-1 flex items-center justify-center relative">
              <video src="./assets/app_assets/archives/videos/vid_cat_attack_slacker.mp4" poster="./assets/video_posters/vid_cat_attack_slacker_poster.jpg" autoplay loop muted playsinline controls class="w-full h-full object-contain"></video>
            </div>
            <div class="text-[8.5px] font-bold text-slate-800 font-mono truncate">06 · 突击警觉</div>
            <div class="text-[7.5px] text-slate-400 font-mono">720×1280 · 9:16 MP4</div>
          </div>
        </div>
      </div>

      <!-- ===================================================================== -->
      <!-- ZONE SOUTHEAST (东南总成 · X: 2850, Y: 2200) · 材质 Shader 与光照微纹理实验台 -->
      <!-- ===================================================================== -->
      <div id="zone-shaders" class="absolute z-20 draggable-node blueprint-card p-5 rounded-2xl" style="left: 2850px; top: 2200px; width: 1460px;">
        <div class="flex items-center justify-between border-b border-slate-200 pb-3 mb-3.5 node-drag-handle">
          <div class="flex items-center gap-2.5">
            <span class="w-8 h-8 rounded-xl bg-rose-50 border border-rose-200 flex items-center justify-center text-base">🎨</span>
            <div>
              <h3 class="font-black text-slate-900 text-xs">材质 Shader 与光照微纹理实验台 (比例校准 · 零剪裁)</h3>
        ...
        <div class="grid grid-cols-4 gap-3">
          ...
          <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/app_assets/generated/podium_3d.png', 'Shader 贴图 01 · 3D 全景领奖台模型 (1375×548 · 2.5:1)')">
            <div class="w-full aspect-wide-2-5 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center p-1">
              <img src="./assets/app_assets/generated/podium_3d.png" class="no-crop-img" alt="podium_3d">
            </div>
            <div class="text-[9px] font-bold text-slate-800 font-mono truncate">PODIUM_3D (2.5:1)</div>
            <div class="text-[8px] text-slate-400 font-mono">1375×548 空间网格</div>
          </div>
          ...
          <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/app_assets/generated/podium_leaderboard.png', 'Shader 贴图 02 · 领奖台空间光影贴图 (1536×1024 · 1.5:1)')">
            <div class="w-full aspect-wide-1-5 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center p-1">
              <img src="./assets/app_assets/generated/podium_leaderboard.png" class="no-crop-img" alt="podium_leaderboard">
            </div>
            <div class="text-[9px] font-bold text-slate-800 font-mono truncate">PODIUM_LIGHT (1.5:1)</div>
            <div class="text-[8px] text-slate-400 font-mono">1536×1024 漫反射</div>
          </div>
          ...
          <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/app_assets/generated/btn_archive_texture.png', 'Shader 贴图 03 · 档案手账材质着色器贴图 (1774×887 · 2.0:1)')">
            <div class="w-full aspect-wide-2-1 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center">
              <img src="./assets/app_assets/generated/btn_archive_texture.png" class="no-crop-img" alt="btn_archive_texture">
            </div>
            <div class="text-[9px] font-bold text-slate-800 font-mono truncate">BTN_ARCHIVE_TEX</div>
            <div class="text-[8px] text-slate-400 font-mono">1774×887 (2.0:1)</div>
          </div>
          ...
          <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/app_assets/generated/btn_rank_texture.png', 'Shader 贴图 04 · 排行榜材质着色器贴图 (1774×887 · 2.0:1)')">
            ...
            <div class="text-[9px] font-bold text-slate-800 font-mono truncate">BTN_RANK_TEX</div>
            <div class="text-[8px] text-slate-400 font-mono">1774×887 (2.0:1)</div>
          </div>
          ...
          <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/app_assets/generated/btn_white_ceramic_texture.png', 'Shader 贴图 05 · 白色微晶陶瓷质感贴图 (1374×1145 · 1.2:1)')">
            <div class="w-full aspect-tex-1-2 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center">
              <img src="./assets/app_assets/generated/btn_white_ceramic_texture.png" class="no-crop-img" alt="ceramic">
            </div>
            <div class="text-[9px] font-bold text-slate-800 font-mono truncate">CERAMIC_TEX</div>
            <div class="text-[8px] text-slate-400 font-mono">1374×1145 (1.2:1)</div>
          </div>
          ...
          <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/app_assets/generated/ic_archive_journal.png', 'Shader 贴图 06 · 3D 手账立体渲染贴图')">
            <div class="w-full aspect-square-1-1 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center p-1">
              <img src="./assets/app_assets/generated/ic_archive_journal.png" class="no-crop-img" alt="journal">
            </div>
            <div class="text-[9px] font-bold text-slate-800 font-mono truncate">IC_JOURNAL_3D</div>
            <div class="text-[8px] text-slate-400 font-mono">手账立体图标</div>
          </div>
          ...
          <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/app_assets/generated/btn_archive_art.png', 'Shader 贴图 07 · 手账艺术光影着色图 (1536×1024 · 1.5:1)')">
            <div class="w-full aspect-wide-1-5 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center">
              <img src="./assets/app_assets/generated/btn_archive_art.png" class="no-crop-img" alt="btn_archive_art">
            </div>
            <div class="text-[9px] font-bold text-slate-800 font-mono truncate">BTN_ARCHIVE_ART</div>
            <div class="text-[8px] text-slate-400 font-mono">1536×1024 (1.5:1)</div>
          </div>
          ...
          <div class="bg-slate-50 p-2.5 rounded-xl border border-slate-200 cursor-pointer hover:border-rose-400 transition-all" onclick="inspectImage('./assets/app_assets/generated/btn_rank_art.png', 'Shader 贴图 08 · 排行榜艺术高光着色图 (1536×1024 · 1.5:1)')">
            ...
            <div class="text-[9px] font-bold text-slate-800 font-mono truncate">BTN_RANK_ART</div>
            <div class="text-[8px] text-slate-400 font-mono">1536×1024 (1.5:1)</div>
          </div>
        </div>
      </div>
      ...
      <!-- ===================================================================== -->
      <!-- ZONE SOUTH (南部总成 · X: 1400, Y: 2450) · 15 位工程贡献者紧凑矩阵 (绝对无重叠) -->
      <!-- ===================================================================== -->
      <div id="zone-team" class="absolute z-20 draggable-node blueprint-card p-5 rounded-2xl" style="left: 1400px; top: 2450px; width: 1300px;">
        <div class="flex items-center justify-between border-b border-slate-200 pb-3 mb-3.5 node-drag-handle">
          <div class="flex items-center gap-2.5">
            <span class="w-8 h-8 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-center text-base">👥</span>
            <div>
              <h2 class="text-xs font-black text-slate-900 tracking-tight">工程核心贡献者与系统总线责任人架构图 (1:1 正方原生画幅 · 严格对齐紧凑矩阵)</h2>
              <span class="text-[9px] font-mono text-blue-600 font-bold">[ZONE-SOUTH · 15 REAL CONTRIBUTORS MAPPING & METRIC ALIGNMENT]</span>
            </div>
          </div>
          <div class="flex items-center gap-2">
        ...
        <!-- Aligned Compact Grid of 15 Contributors -->
        <div id="unified-team-grid" class="grid grid-cols-5 gap-2.5">
          <!-- Rendered via JS -->
        </div>
      </div>
  ...
  <!-- ========================================================================= -->
  <aside id="inspector-drawer" class="fixed top-14 right-0 bottom-0 w-[420px] bg-white/95 backdrop-blur-2xl border-l border-slate-200 shadow-2xl z-50 p-5 flex flex-col justify-between transform translate-x-[420px] transition-transform duration-300 ease-out">
    <div>
      ...
      <div class="space-y-2.5 font-mono text-[11px]">
        <div class="flex justify-between border-b border-slate-100 pb-1.5">
          ...
          <span id="insp-name" class="font-bold text-slate-800 truncate max-w-[240px]">-</span>
        </div>
        <div class="flex justify-between border-b border-slate-100 pb-1.5">
          <span class="text-slate-400">物理路径 / PATH</span>
          <span id="insp-path" class="font-bold text-blue-600 truncate max-w-[240px]">-</span>
        </div>
        <div class="flex justify-between border-b border-slate-100 pb-1.5">
    ...
    <div class="pt-3 border-t border-slate-200 flex items-center justify-between text-[10px] font-mono text-slate-400">
      <span>HONOR YOYO INSPECTOR v2.8</span>
  ...
  <!-- ========================================================================= -->
  <!-- JAVASCRIPT: PAN, ZOOM, FIGMA-LIKE DRAGGING & LEADER LINE ENGINE           -->
  <!-- ========================================================================= -->
  <script>
    // -------------------------------------------------------------------------
    // 1. Core Data Models
    ...
    function switchPhoneScreen(id) {
      ...
      for (let i = 1; i <= 8; i++) {
        const btn = document.getElementById(`btn-scr-1`.replace('1', i));
        if (btn) {
          if (i === id) {
    ...
    viewport.addEventListener('mousedown', (e) => {
      // Ignore clicks on inputs, buttons, videos
      ...
      if (draggableNode) {
        // Start dragging this specific component!
    ...
    window.addEventListener('mousemove', (e) => {
      if (activeDraggedNode) {
        // Move component by delta scaled by zoomScale
    ...
    function resetView() {
      const vW = viewport.clientWidth;
      const vH = viewport.clientHeight;
      const fitScale = Math.min(vW / 4400, vH / 3100) * 0.95;
      zoomScale = Math.max(0.18, fitScale);
      panX = (vW - 4400 * zoomScale) / 2;
      panY = (vH - 3100 * zoomScale) / 2;
      applyTransform();
    }
    ...
    function updateExplosion(val) {
      ...
      // Translate 4 core exploded modules outward with safe limits
    ...
    function drawLeaderLines() {
      ...
      // Connect Chassis to 4 Exploded Sub-Assemblies
      addLine(frame.x, frame.top + 40, gauges.x, gauges.bottom, '#2563EB'); // Top Gauges
      addLine(frame.right - 20, frame.y - 120, media.left, media.y, '#059669'); // Right Media
      addLine(frame.left + 20, frame.y + 120, timeline.right, timeline.y, '#D97706'); // Left Timeline
      addLine(frame.x, frame.bottom - 40, bento.x, bento.top, '#4F46E5'); // Bottom Bento

      // Connector lines to satellite zones
    ...
    function populateTimeline() {
      ...
      SCHEDULE_DATA.slice(0, 8).forEach(it => {
        html += `
          <div class="bg-slate-50 p-1.5 rounded-lg border border-slate-200 flex flex-col items-center text-center cursor-pointer hover:border-amber-400" onclick="inspectItem(${it.id})">
            <div class="w-7 h-7 flex items-center justify-center mb-0.5">
              <img src="${it.icon}" class="no-crop-img" alt="${it.title}">
            </div>
            <span class="text-[8.5px] font-black text-slate-800 truncate w-full font-mono">${it.title.slice(0, 4)}</span>
            <span class="text-[7.5px] text-slate-400 font-mono">${it.time}</span>
          </div>
        `;
      });
    ...
    function populateBOM() {
      ...
      SCHEDULE_DATA.forEach(it => {
        bHtml += `
          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all flex flex-col items-center text-center cursor-pointer" onclick="inspectItem(${it.id})">
            ...
            <span class="text-[9.5px] font-black text-slate-800 truncate w-full font-mono">${it.title}</span>
            <span class="text-[8px] text-slate-400 font-mono mt-0.5">${it.time} · ${it.person}</span>
          </div>
        `;
      });
      ...
      const uiControls = [
        ...
        { name: 'ic_index_happiness.png', title: '快乐值基础仪表', path: './assets/app_assets/ui_icons/ic_index_happiness.png' },
        { name: 'ic_index_happiness_blue.png', title: '清爽低饱和仪表', path: './assets/app_assets/ui_icons/ic_index_happiness_blue.png' },
        { name: 'ic_index_happiness_green.png', title: '活力健康态仪表', path: './assets/app_assets/ui_icons/ic_index_happiness_green.png' },
        { name: 'ic_index_happiness_orange.png', title: '疲惫警戒态仪表', path: './assets/app_assets/ui_icons/ic_index_happiness_orange.png' },
        { name: 'ic_index_happiness_red.png', title: '脏污高急迫仪表', path: './assets/app_assets/ui_icons/ic_index_happiness_red.png' },
        { name: 'ic_index_happiness_tight.png', title: '紧凑版指标切图', path: './assets/app_assets/ui_icons/ic_index_happiness_tight.png' },
        { name: 'ic_btn_like.png', title: '点赞默认状态', path: './assets/app_assets/ui_icons/ic_btn_like.png' },
        { name: 'ic_btn_like_active.png', title: '点赞高亮激活态', path: './assets/app_assets/ui_icons/ic_btn_like_active.png' },
        { name: 'ic_btn_comment.png', title: '手账评论留言', path: './assets/app_assets/ui_icons/ic_btn_comment.png' },
        { name: 'ic_btn_expand.png', title: '展开折叠手柄', path: './assets/app_assets/ui_icons/ic_btn_expand.png' },
        { name: 'ic_btn_collapse.png', title: '收起复位手柄', path: './assets/app_assets/ui_icons/ic_btn_collapse.png' }
      ];
      let uHtml = '';
      uiControls.forEach(ui => {
        uHtml += `
          <div class="bg-slate-50 p-2 rounded-xl border border-slate-200 hover:border-rose-400 transition-all flex flex-col items-center text-center cursor-pointer" onclick="inspectImage('${ui.path}', '${ui.title}')">
            <div class="w-9 h-9 cleanroom-pad rounded-lg flex items-center justify-center mb-1 p-0.5 border border-slate-200 shadow-2xs">
              <img src="${ui.path}" class="no-crop-img drop-shadow-2xs" alt="${ui.title}">
            </div>
            <span class="text-[9px] font-black text-slate-800 truncate w-full font-mono">${ui.title}</span>
            <span class="text-[7.5px] text-slate-400 font-mono mt-0.5 truncate w-full">${ui.name}</span>
          </div>
        `;
      });
      ...
      [163, 164, 165, 166, 167, 168, 169].forEach(id => {
        aHtml += `
          <div class="bg-slate-50 p-1.5 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all">
            <div class="w-full h-24 bg-slate-900/5 rounded-lg overflow-hidden mb-1 flex items-center justify-center p-1 cursor-pointer hover:scale-105 transition-transform" onclick="inspectImage('./assets/app_assets/archives/archive_${id}.png', '持久化数据记录 #${id}')">
              <img src="./assets/app_assets/archives/archive_${id}.png" class="no-crop-img" alt="手账${id}">
            </div>
            <div class="text-[8.5px] font-bold text-slate-700 text-center font-mono">RECORD #${id}</div>
            <div class="text-[7.5px] text-slate-400 text-center font-mono">零裁剪</div>
          </div>
        `;
      });
    ...
    function populateTeam() {
      ...
      TEAM_MEMBERS.forEach(m => {
        html += `
          <div class="p-2.5 rounded-xl bg-slate-50 border border-slate-200 hover:border-blue-500 hover:bg-white transition-all flex items-center gap-3 cursor-pointer" onclick="inspectMember('${m.alias}')">
            <!-- Strictly Aligned 44x44 Square Avatar Token (1:1 Natural Aspect Ratio) -->
            <div class="engineer-avatar-box shadow-2xs ring-1 ring-slate-200 flex-shrink-0 flex items-center justify-center p-0.5">
              <img src="${m.avatar}" class="no-crop-img" alt="${m.alias}">
            </div>
            <div class="overflow-hidden text-left flex-1">
              <div class="text-[11px] font-black text-slate-900 font-mono truncate">${m.alias} <span class="text-[9px] font-normal text-slate-400">(${m.name})</span></div>
              <div class="text-[9.5px] font-bold text-blue-600 font-mono truncate">${m.role}</div>
            </div>
          </div>
        `;
      });
    ...
    function closeInspector() {
      document.getElementById('inspector-drawer').classList.add('translate-x-[420px]');
    }
...
print("Rebuilt Compact Draggable Showcase generated successfully!")
